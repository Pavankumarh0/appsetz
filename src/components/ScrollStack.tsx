...
const ScrollStack: FC<ScrollStackProps> = ({
    ...
    const updateCardTransforms = useCallback(() => {
        ...
        cardsRef.current.forEach((card, i) => {
            ...
            const cardTop = getElementOffset(card as HTMLElement);
            ...
            if (blurAmount) {
                ...
                for (let j = 0; j < cardsRef.current.length; j++) {
                    ...
                    const jCardTop = getElementOffset(jCard as HTMLElement);
    ...
    const setupLenis = useCallback(() => {
        if (useWindowScroll) {
            const lenis = new Lenis({
                ...
                // smoothWheel: true, // Deprecated in v1+? Checking usage. Assuming compatible with v1 or providing compatible options.
                // touchMultiplier: 2,
                infinite: false,
                // wheelMultiplier: 1,
                lerp: 0.1,
    ...
    useLayoutEffect(() => {
        ...
        // Wait a tick to ensure elements are rendered
        setTimeout(() => {
